/*:
## Ejercicio: Usa playgrounds

 El siguiente código imprime una serie de instrucciones cortas sobre lo que aprendiste en esta lección. Abre el área de la consola y observa los datos del código.
 */

print("Aprendí lo siguiente:")
print("Qué características hacen que Swift sea un lenguaje moderno y seguro")
print("Cómo usar la herramienta Swift REPL en Terminal")
print("Cómo usar playgrounds para que escribir código Swift sea divertido y sencillo")
print("Estoy en el iOS Lab")
...
//:  Usa varias funciones `print` para escribir parte de la letra de la canción.
