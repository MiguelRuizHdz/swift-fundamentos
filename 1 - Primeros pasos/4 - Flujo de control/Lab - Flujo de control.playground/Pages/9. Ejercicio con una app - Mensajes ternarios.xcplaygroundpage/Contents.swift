/*:
## Ejercicio con una app: Mensajes ternarios
 ...
 El código a continuación debe ser similar al código que escribiste en el ejercicio Decisiones sobre el entrenamiento. La instrucción “if-else” es innecesaria y, en su lugar, puedes imprimir una declaración o todas las demás en una línea con un operador ternario. Sigue adelante y refactoriza el código a continuación para hacer justamente eso.
 */
let stepGoal = 10000
let steps = 3948

if steps < stepGoal / 2 {
    print("¡Casi llegas a la mitad!")
} else {
    print("¡Pasaste la mitad!")
}
/*:
